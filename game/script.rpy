...
define gar = Character("Garlic Johansonn", color="#c3acce", callback = name_callback, cb_name = "garlic")
define gin = Character("Ginger Snap", color="#c3acce", callback = name_callback, cb_name = "ginger")
